...
func (h *tenantHandler) QueryMeteringGPU(req *restful.Request, resp *restful.Response) {
	...
	res, err := h.tenant.MeteringGPU(u, q, h.meteringOptions.Billing.PriceInfo)
	if err != nil {
		api.HandleBadRequest(resp, nil, err)
		return
	}
	...
	if q.Operation == monitoringv1alpha3.OperationExport {
		...
		monitoringv1alpha3.ExportMetricsGPU(resp, res, startTime, endTime)
		return
	}
