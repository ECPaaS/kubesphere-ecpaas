...
type CPolicy struct {
	...
	CtrledValues    string     `json:"controlledValues" default:"RequestsAndLimits" description:"Specifies which resource values should be controlled. Available input: RequestsAndLimits, RequestsOnly"`
}
