...
type PriceInfo struct {
	...
	CpuPerCorePerHour float64 `json:"cpu_per_core_per_hour" description:"cpu price"`
	// mem cost with above currency unit for per GB per hour
	MemPerGigabytesPerHour float64 `json:"mem_per_gigabytes_per_hour" description:"mem price"`
	// ingress network traffic cost with above currency unit for per MB per hour
	IngressNetworkTrafficPerMegabytesPerHour float64 `json:"ingress_network_traffic_per_megabytes_per_hour" description:"ingress price"`
	// egress network traffice cost with above currency unit for per MB per hour
	EgressNetworkTrafficPerMegabytesPerHour float64 `json:"egress_network_traffic_per_megabytes_per_hour" description:"egress price"`
	// pvc cost with above currency unit for per GB per hour
	PvcPerGigabytesPerHour float64 `json:"pvc_per_gigabytes_per_hour" description:"pvc price"`
	// gpu cost with above currency unit for per percentage per hour
	GpuPerPercentagePerHour float64 `json:"gpu_per_percentage_per_hour" description:"gpu price"`
}
